...
VT Code is a CLI coding assistant that provides AI-powered code assistance in your terminal.

```
Usage: vtcode [options] [prompt]

VT Code - Terminal-based AI coding assistant
